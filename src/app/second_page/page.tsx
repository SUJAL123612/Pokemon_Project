        ...
        <>
            ...
            <div className="flex mt-[-300px] space-x-10 ml-[140px]">
                ...
                <div className="flex flex-col space-y-4 relative z-10">
                    ...
                    />
                    <button className="bg-red-600 text-white px-6 py-2 rounded hover:bg-red-400 hover:text-white/80 cursor-pointer">
                        OK
                    </button>
                </div>
                <div className="w-[450px] h-[450px] ml-[-45px] mt-[-130px]">
                <img src="ash.png" alt="ASH" className="w-full h-full object-contain"/>
            </div>
            </div>
        </>
    );
